...
function validatePass() {
    ...
    if (!re.test(Password.value) && Password.value != "") {
        ...
        alertmessages += "Pasword must have at least 6 characters and must contain at least one digit and one upper-case character<br>"
    }
}
...
function validateProvince() {
    ...
    if (!myStringArray.includes(Province.value) && Province.value != "") {
        ...
        alertmessages += "The province " + Province.value + " is not allowed<br>";
    }
}
